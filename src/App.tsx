...
import { Plus, Trash2, RefreshCcw, Calculator, Info } from "lucide-react";
...
// Standard P/L Calculation logic

const calculateOutcomePL = (odds, stake, isWin) => {
...
const OutcomeRow = ({ outcome, onUpdate, onDelete }) => {
  ...
  return (
    ...
    <div
      ...
      className={`grid grid-cols-12 gap-2 items-center p-2 mb-2 rounded border-l-4 ${bgState} transition-all duration-200`}
...
const EventCard = ({ event, onUpdateEvent, onDeleteEvent }) => {
  ...
  const eventStats = useMemo(() => {
    ...
    event.outcomes.forEach((o) => {
      ...
      totalStake += parseFloat(o.stake) || 0;

      currentPL += p;

      if (parseFloat(o.odds) > 0) {

        impliedProbSum += 1 / parseFloat(o.odds);
        ...
        <div className="text-xs text-gray-500">
          ...
          <div>
            ...
            <span className="font-mono">
              ...
              {(eventStats.impliedProbSum * 100).toFixed(1)}%
          ...
          {eventStats.impliedProbSum > 1 && (
            ...
            <div>
              ...
              {((eventStats.impliedProbSum - 1) * 100).toFixed(1)}%
        ...
        <div className="text-right">
          ...
          <div className="text-sm text-gray-600">
            ...
            <span className="font-mono">
              ...
              {eventStats.totalStake.toFixed(2)}
          ...
          <div className="text-lg font-bold flex justify-end items-center gap-2">
            ...
            <span
              ...
              className={`font-mono ${
                ...
                eventStats.currentPL >= 0 ? "text-green-600" : "text-red-600"
  ...
  const globalStats = useMemo(() => {
    ...
    events.forEach((e) => {
      ...
      e.outcomes.forEach((o) => {
        ...
        grandTotalStake += parseFloat(o.stake) || 0;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-8">
          ...
          <p className="text-gray-600 text-sm max-w-2xl">
            ...
            A deterministic tool for analyzing probability, risk distribution,

            and "what-if" scenarios. Define outcomes, set toggles, and view

            instant P/L calculations. This is a calculator, not a predictor.
        ...
        <div className="bg-slate-800 text-white p-4 rounded-lg shadow-lg mb-8 flex justify-between items-center sticky top-4 z-10">
          ...
          <div>
            ...
            <div className="text-2xl font-mono font-bold">
              ...
              {globalStats.grandTotalStake.toFixed(2)}
